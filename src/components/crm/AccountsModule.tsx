  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage organizations and account records</p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button onClick={() => onOpenForm("accounts")} size="default" className="gap-2 shadow-sm">
